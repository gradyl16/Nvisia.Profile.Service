...
public class UpdateProfileRequestValidatorTest
{
    ...
    public UpdateProfileRequestValidatorTest()
	{
		_validator = new UpdateProfileRequestValidator(_titleCodeService);
	}
    ...
    private static UpdateProfileRequest CreateValidRequest()
        => Fixture.Build<UpdateProfileRequest>()
